export default {
  ...
  fields: [
    ...
    },
    {
      name: "keywords",
      title: "SEO Keywords",
      description: "SEO keywords for this post. Used in meta tags.",
      type: "array",
      of: [{ type: "string" }],
      validation: Rule => Rule.max(10).warning("Limit to 10 keywords for best SEO")
    },
    {
      name: "publishedAt",
      title: "Published at",
    ...
    },
    {
      ...
      description: "Authoritative sources cited in this post. Rendered as a 'Sources' section and used as trust signals by AI systems.",
      type: "array",
      of: [
        {
          type: "object",
          fields: [
            ...
            },
            {
              name: "domain",
              type: "string",
              title: "Domain / Publisher",
              description: "e.g., 'Gartner', 'McKinsey', 'Harvard Business Review'"
            }
          ],
          preview: {
            select: {
