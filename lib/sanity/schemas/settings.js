...
export default defineType({
  ...
  fieldsets: [
    ...
    },
    {
      title: "Sidebar CTA",
      name: "sidebarCta",
      description: "Generic call-to-action shown on all blog posts",
      options: {
        collapsible: true,
        collapsed: false
      }
  ...
  fields: [
    ...
    defineField({
      name: "genericCtaHeadline",
      type: "string",
      title: "Headline",
      description: "CTA headline (e.g., 'Ready to talk?')",
      fieldset: "sidebarCta"
    }),
    defineField({
      name: "genericCtaBody",
    ...
    defineField({
      name: "genericCtaButtonText",
      type: "string",
      title: "Button Text",
      description: "Button label (e.g., 'Book a call')",
      fieldset: "sidebarCta"
    }),
    defineField({
      name: "genericCtaButtonUrl",
      type: "url",
      title: "Button URL",
      description: "Where the button links to (e.g., Calendly)",
      fieldset: "sidebarCta",
